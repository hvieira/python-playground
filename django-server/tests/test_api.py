...
class TestPollsApi():
    ...
    def test_get_polls_nothing_in_db(self, api_client: APIClient):
        response = api_client.get('/api/polls/')
        assert response.data == []

    def test_get_polls_with_existing_polls(self, api_client: APIClient):
    ...
    def test_create_poll(self, api_client: APIClient):
        ...
        assert response.data['question_text'] == question_text
