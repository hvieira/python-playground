...
from store_async_jobs.consumer import Consumer


class TestRedisStreamConsumer:

    DUMMY_REDIS_HOST_NAME = "localhost"
    ...
    def test_consumer_init_handles_consumer_group_setup(self):
    ...
    def test_consumer_init_handles_consumer_group_already_created(self):
        redis_client = Redis(self.DUMMY_REDIS_HOST_NAME)
    ...
    def test_consumer_reads_from_stream_gets_pending_messages_first(self):
        ...
        assert events == []
        assert redis_client.xreadgroup.call_args_list == [
            call(
